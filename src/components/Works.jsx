...
import { github, arrowup } from "../assets";
        ...
        <div className="relative w-full h-[230px] sm:h-[200px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div
              ...
              className="green-pink-gradient w-8 h-8 rounded-full flex justify-center items-center cursor-pointer"
            >
              <img
                src={github}
                alt="github"
    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          links to the websites and GitHub repositories (if can be shared
          publicly). It reflects my ability to solve complex problems, work with
